import AOD_devkit.AOD_utils as util
import os
import cv2
import json
...
def DOTA2COCOTrain(srcpath, destfile, cls_names, difficult='-1'):
    ...
    with open(destfile, 'w') as f_out:
        ...
        for file in filenames:
            ...
            for obj in objects:
                ...
                single_obj['angle'] = obj['angle']  # todo lcl angle
...
if __name__ == '__main__':
    ...
    DOTA2COCOTrain(r'D:/workspace/crnet/dataset/train/',
                   r'D:/workspace/crnet/dataset/AOD_train.json',
                   wordname)
    DOTA2COCOTrain(r'D:/workspace/crnet/dataset/val/',
                   r'D:/workspace/crnet/dataset/AOD_test.json',
                   wordname)
    # DOTA2COCOTest(r'D:/workspace/crnet/dataset/val/',
    #               r'D:/workspace/crnet/dataset/AOD_test.json',
    #               wordname)
